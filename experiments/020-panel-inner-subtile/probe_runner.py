"""Runs inside the Modal B200 sandbox for experiment 020.

Paired same-process probe: times the exact ranked exp-019 baseline (#882825)
against an exp-020 candidate on the target shapes, mirroring the official
...
def main():
    ...
    payload = {
        "schema_version": 1,
        "experiment": "020-panel-inner-subtile",
        "mode": "paired-probe",
