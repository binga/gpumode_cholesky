"""Launch the experiment-020 panel-inner subtiling probe on a Modal B200.

Uploads the exact ranked baseline (exp-019, #882825), one candidate,
...
def main():
    ...
    parser.add_argument("--candidate", default="candidate-subtile64-probe.py")
    parser.add_argument(
        "--baseline",
        default=None,
        help="baseline file (defaults to frozen exp-019 ranked snapshot)",
    )
    ...
    baseline = Path(args.baseline) if args.baseline else EXP / "baseline-exp019.py"
