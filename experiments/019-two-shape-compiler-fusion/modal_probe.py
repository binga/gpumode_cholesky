"""Launch the experiment-019 two-shape compiler probe on a Modal B200.
...
EXP = ROOT / "experiments" / "019-two-shape-compiler-fusion"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--candidate", default="candidate-artifacts.py")
    parser.add_argument(
        "--baseline",
        default=None,
    ...
    app = modal.App.lookup("gpumode-cholesky-exp019", create_if_missing=True)
    payload = None
    artifact_parts = []
