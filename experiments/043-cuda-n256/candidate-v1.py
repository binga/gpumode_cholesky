...
#
# A full padded 256x256 FP32 tile exceeds one CTA's shared-memory budget, but
# the 32,896-value lower triangle fits in 131,584 bytes. One 16-warp CTA owns a
# matrix and keeps the complete blocked-16 factorization in that packed tile,
...
constexpr int TRI_VALUES256 = N256 * (N256 + 1) / 2;
constexpr int SHARED_BYTES256 = TRI_VALUES256 * sizeof(float);
...
if torch.cuda.is_available():
    try:
        ...
        _CUDA256 = load_inline(
            name="chol256_exp043_v1_packed_b16_t512",
