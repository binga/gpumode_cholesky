"""Experiment 039 V6c: V6 kernel with allocation folded into one C++ call."""
...
torch::Tensor chol32(torch::Tensor src) {
...
if torch.cuda.is_available():
    try:
        ...
        _CUDA32 = load_inline(
            name="chol32_exp039_v6c",
            cpp_sources="torch::Tensor chol32(torch::Tensor);",
...
def custom_kernel(data):
    global _CUDA32_HITS
    if _CUDA32 is not None and data.is_cuda and data.shape == (4096, 32, 32):
        _CUDA32_HITS += 1
        return _CUDA32.chol32(data)
