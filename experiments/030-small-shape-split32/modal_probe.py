...
EXP = ROOT / "experiments" / "030-small-shape-split32"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--candidate", default="candidate-route-64-128.py")
    parser.add_argument(
        "--baseline",
        default=None,
    ...
    app = modal.App.lookup("gpumode-cholesky-exp030", create_if_missing=True)
    payload = None
    artifact_parts = []
