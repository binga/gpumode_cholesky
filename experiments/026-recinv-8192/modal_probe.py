"""Launch the experiment-026 recursive-inversion 8192 probe on a Modal B200.
...
EXP = ROOT / "experiments" / "026-recinv-8192"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--candidate", default="candidate-recinv.py")
    parser.add_argument(
        "--baseline",
        default=None,
    ...
    app = modal.App.lookup("gpumode-cholesky-exp026", create_if_missing=True)
    payload = None
    artifact_parts = []
