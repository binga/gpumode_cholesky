"""Runs inside the Modal B200 sandbox for experiment 026.

Paired same-process probe: times the exact ranked exp-021 baseline (#882958)
against an exp-026 candidate on 1x8192, mirroring the official
...
TARGET_SPECS = [{"batch": 1, "n": 8192, "cond": 2, "seed": 48192}]
