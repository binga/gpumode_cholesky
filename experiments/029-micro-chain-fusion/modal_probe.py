"""Launch the experiment-029 micro-chain probe on a Modal B200.
...
EXP = ROOT / "experiments" / "029-micro-chain-fusion"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--candidate", default="candidate-v1-noinv-solve.py")
    parser.add_argument(
        "--baseline",
        default=None,
    ...
    app = modal.App.lookup("gpumode-cholesky-exp029", create_if_missing=True)
    payload = None
    artifact_parts = []
