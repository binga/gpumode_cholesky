"""Runs inside the Modal B200 sandbox for experiment 022.

Paired same-process probe: times the exact ranked exp-021 baseline (#882958)
against an exp-022 candidate on the target shape, mirroring the official
...
TARGET_SPECS = [{"batch": 4096, "n": 32, "cond": 2, "seed": 41032}]
