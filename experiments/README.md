...
| 010 | exact `1×16384` Blackwell ladder: triangular TF32/SYRK, FP8, hierarchical diagonal/panel, inverse-panel GEMM, left-looking | best 18,512.6→15,882.0μs (1.166×); strict target was ≥2.00× | — | **rejected** (six-architecture bounded exhaustion; root unchanged) |
