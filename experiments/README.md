...
| 055 | exact `1x32768` decomposition followed by recursive-inverse base 512→1024 at `1x16384`/`1x32768`; combine unchanged CUDA32/64/128 sources after an official cold-compile failure | profile: POTRF 27.0%, TRSM 21.8%; targets 1.0296x/1.0206x; exact grid 1.003235x; cold import 133.49→27.73s; test #897759 17/17; ranked 905.105us public / 810.869us secret | #897763 | **rejected: public regressed 12.86%, secret improved 4.36%; #890798 remains current** |
