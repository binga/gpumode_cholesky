...
// Experiment 071 variant 2: four rows per 128-thread block. Each warp owns one
// row; the smaller block trades twice as many CTAs for lower per-CTA residency
// than variant 1. Lower-triangular values remain untouched.
