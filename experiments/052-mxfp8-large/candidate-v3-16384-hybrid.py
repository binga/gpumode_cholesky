"""Experiment 052 V3: clip-safe MXFP8 plus a final TF32 panel at 1x16384."""
...
def _hybrid_panel_update(out: torch.Tensor, lhs: torch.Tensor, rhs: torch.Tensor) -> None:
    global _TF32_FINAL_PANEL_HITS
    if lhs.shape[1] >= 12288:
        out.addmm_(
            lhs,
            rhs.transpose(-1, -2),
            beta=1.0,
