...
# ---------------------------------------------------------------------------
# Experiment 058 V1: breadth-first blocked triangular inverse at 1x32768.
#
...
# each tree level with batched GEMMs.  The panel/diagonal arithmetic, MXFP8
# updates, panel width, and every other shape dispatch remain unchanged.
# ---------------------------------------------------------------------------
