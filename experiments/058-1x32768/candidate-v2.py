...
# ---------------------------------------------------------------------------
# Experiment 058 V2: 2048-wide schedule plus blocked inverse at 1x32768.
#
...
# each tree level with batched GEMMs.  With that dependency bottleneck removed,
# halve the panel width to reduce aggregate POTRF and panel-apply work; accept
# twice as many MXFP8 updates. Every other shape dispatch remains unchanged.
# ---------------------------------------------------------------------------
