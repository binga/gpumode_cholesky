...
if _HAVE_TRITON:
    ...
    _SPLIT32_SHAPES = {
        ...
        (256, 128): ("fp16x3", "tf32x3", 128, "graph", True),
        (64, 256): ("fp16x3", "tf32x3", 128, "graph", True),
        (16, 512): ("fp16x3", "tf32x3", 128, "graph", True),
        (640, 512): ("fp16x3", "tf32", 128, "eager", True),
        (4, 1024): ("fp16x3", "tf32", 128, "graph", True),
        (60, 1024): ("fp16x3", "tf32", 128, "eager", False),
        (8, 2048): ("fp16x3", "tf32", 128, "graph", True),
    }
    _SPLIT32_TILE = 128
    _SPLIT32_NB = 128
