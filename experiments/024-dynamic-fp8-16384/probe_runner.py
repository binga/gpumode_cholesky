"""Runs inside the Modal B200 sandbox for experiment 024.

Paired same-process probe: times the exact ranked exp-021 baseline (#882958)
against an exp-024 candidate on 1x16384, mirroring the official
...
TARGET_SPECS = [{"batch": 1, "n": 16384, "cond": 2, "seed": 48284}]
