"""Launch the experiment-024 dynamic FP8 16384 probe on a Modal B200.
...
EXP = ROOT / "experiments" / "024-dynamic-fp8-16384"


def main():
    parser = argparse.ArgumentParser()
    parser.add_argument("--candidate", default="candidate-fp8.py")
    parser.add_argument(
        "--baseline",
        default=None,
    ...
    app = modal.App.lookup("gpumode-cholesky-exp024", create_if_missing=True)
    payload = None
    artifact_parts = []
