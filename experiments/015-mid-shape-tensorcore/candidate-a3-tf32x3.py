...
"""GPU MODE `cholesky` submission — experiment 015 candidate A round 3 (tf32x3 dots).
...
if _HAVE_TRITON:
    ...
    _SPLIT32_SHAPES = {
        (64, 256): ("tf32x3", "tf32x3", True),
        (16, 512): ("tf32x3", "tf32x3", True),
        (640, 512): ("tf32x3", "tf32", True),
        (4, 1024): ("tf32x3", "tf32", True),
        (60, 1024): ("tf32x3", "tf32", True),
        (2, 2048): ("tf32x3", "tf32", True),
        (8, 2048): ("tf32x3", "tf32", True),
    }
    _SPLIT32_TILE = 128
